export default async function fetchData({ transactionHash }: { transactionHash: string }): Promise<any> {
  ...
  const res = {
    ...
    from: '{"address": "0a3b5e972db484b758109ef2f0d50bfadd88ac92862592427a034bf066c22275"}',
    to: '{}',
    tokensTransferrd: 'string',
    nftsTransferred: 'string',
    burntFee: '2113.0231222',
    value: '1.83194211',
    transactionFee: '1.83194211',
    resourcesFee: '1.83194211',
    TransactionRefBlockNumber: '157076339',
    transactionRefBlockPrefix: '5JlCPA==',
    transactionParams:
    ...
    transactionSignature: 'zBVzvebV9CvyFAcmzZ7uj9MZLMHf2t1xfkECEEpvcUyTa3XU8',
    returnValue: 'returnValue',
    error: 'string',
    transactionSize: '19491',
    logs: [
      {
      ...
      {
        address: '1a3b5e972db484b758109ef2f0d50bfadd88ac92862592427a034bf066c22275',
        name: 'MiningInformationUpdated',
        indexed: [],
        nonIndexed: '',
        decode: JSON.stringify({
