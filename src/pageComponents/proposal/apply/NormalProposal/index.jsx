...
import './index.less';
import { validateURL, getContractMethodList, CONTRACT_INSTANCE_MAP } from '../../../../../common/utils';
    ...
    <div className="normal-proposal">
      <Form
        ...
        <Form.Item {...tailFormItemLayout}>
          <Button className="apply-btn" style={{ width: '240px' }} type="primary" size="large" onClick={handleSubmit}>
            Apply
          </Button>
        </Form.Item>
      </Form>
