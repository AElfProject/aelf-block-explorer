...
import './index.less';
import { isPhoneCheck } from '@_utils/isMobile';
...
function getCircleValues(proposalType, { approvals, rejections, abstentions }, organization, bpCount = 1) {
...
const VoteChart = (props) => {
  const { organizationInfo, bpCount, proposalType, approvals, rejections, abstentions } = props;
  ...
  if (isPhoneCheck()) {
    return (
      <div className="proposal-vote">
        ...
        <Row gutter={16}>
          <Col span={12}>
            <div className="text-center proposal-vote-desc">
