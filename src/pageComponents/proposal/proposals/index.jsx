...
import { message, Tabs, Pagination, Input, Checkbox, Select, Spin, Row, Col, Empty, Result, Modal } from 'antd';
...
import { getProposals } from '@_store/actions/proposalList';
import ApproveTokenModal from '../_components/ApproveTokenModal';
import './index.less';
...
const ProposalList = () => {
  ...
  async function handleConfirm(action) {
    if (action) {
      ...
      await sendTransactionWith(callContract, getContractAddress(params.proposalType), action, proposalInfo.proposalId);
    }
    setProposalInfo({
      ...proposalInfo,
      visible: false,
  ...
  const handleRelease = async (event) => {
    ...
    await sendTransactionWith(callContract, getContractAddress(params.proposalType), 'Release', id);
  };
  ...
  return (
    <div className="proposal-list">
      <Tabs className="proposal-list-tab" activeKey={activeKey} onChange={handleTabChange} animated={false}>
      ...
      <div className="proposal-list-filter gap-bottom">
        ...
        <div className="proposal-list-filter-form">
          <div className="proposal-list-filter-form-select">
            ...
            <Select defaultValue={proposalStatus.ALL} value={params.status} onChange={handleStatusChange}>
