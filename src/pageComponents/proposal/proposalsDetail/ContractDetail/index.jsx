...
import { base64ToHex } from '@_store/common/utils';
...
const ContractDetail = (props) => {
  ...
  useEffect(() => {
    ...
    if (
      (createdBy === 'SYSTEM_CONTRACT' && contractMethod !== 'PerformDeployUserSmartContract') ||
  ...
  return (
    <Card
      ...
      <Row>
        ...
        <Col sm={20} xs={24}>
          <a href={getContractURL(addressFormat(contractAddress))} target="_blank" rel="noopener noreferrer">
