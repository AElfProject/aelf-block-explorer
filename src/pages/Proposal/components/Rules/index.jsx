...
const Rules = () => (
  <Typography className="rules">
    <Title level={2} className="rules-title">Proposal Rules</Title>
    <Divider />
    ...
    <Paragraph>
      <ul>
        <li>Organization members are responsible for voting; any user with an aelf address can create an organization. This includes setting Organization members/Token types, Proposal execution threshold ratios/quantities, and Proposer WhiteList. After selecting an organization, any proposal must comply with the organization&lsquo;s regulations.</li>
        <li>
