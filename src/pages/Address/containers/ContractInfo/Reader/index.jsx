...
import { sendHeight } from "@src/common/utils";
...
import { LinkIcon, CodeIcon } from "../../../common/Icon";
import AddressLink from "../../../../../components/AddressLink";

const Viewer = lazy(() =>
  import(/* webpackChunkName: "viewer" */ "../../../components/Viewer")
);
...
const StepDescription = (props) => {
  ...
  return (
    <>
      ...
      <div className="description-item">
        <span>Code Hash: </span>
        <Link to={`/contract/${address}/${codeHash}`}>{codeHash}</Link>
      </div>
      <div className="description-item">
        <span>Version: </span>
        <Link to={`/contract/${address}/${codeHash}`}>{version}</Link>
      </div>
      <div className="description-item">
                  ...
                  <Steps progressDot current={0} direction="vertical">
                    {history.map((v) => (
                      <Step
                        ...
                        subTitle={moment(v.updateTime).format(
                          "YYYY/MM/DD HH:mm:ss"
                        )}
