...
import { Tabs, Pagination, Input, Checkbox, Select, Spin, Row, Col, Empty, Result } from 'antd';
import Total from 'components/Total';
import constants, { LOADING_STATUS, LOG_STATUS } from 'page-components/Proposal/common/constants';
import Proposal from './Proposal';
import { getProposals } from 'redux/features/proposal/proposalList';
...
const ProposalList = () => {
  ...
  return (
    <div className="proposal-list">
      <Tabs className="proposal-list-tab" activeKey={params.proposalType} onChange={handleTabChange} animated={false}>
