...
import ProposalSearch from 'page-components/Proposal/ProposalSearch';
import { destorySelectList, getProposalSelectListWrap } from 'redux/features/proposal/proposalSelectList';
    ...
    <div className="contract-proposal">
      <Form
        ...
        <Form.Item {...tailFormItemLayout}>
          <Button shape="round" type="primary" loading={loading} onClick={handleSubmit}>
            Apply
          </Button>
        </Form.Item>
      </Form>
