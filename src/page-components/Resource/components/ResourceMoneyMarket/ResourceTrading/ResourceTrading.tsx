...
class ResourceTrading extends PureComponent<IProps, IState> {
  ...
  render() {
    const { account, currentResourceType, currentResourceIndex, loginAndInsertKeypairs } = this.props;
    const {
      sellVisible,
      buyVisible,
      currentWallet,
    ...
    return (
      <div className="resource-trading">
        ...
        <div className="resource-trading-body">
          {isPhoneCheck() ? null : (
            <Row>
              <Col className="trading-title-buy" xxl={12} xl={12} lg={12} md={12} sm={24} xs={24}>
                Buy
              </Col>
              <Col className="trading-title-sell" xxl={12} xl={12} lg={12} md={12} sm={24} xs={24}>
                Sell
              </Col>
            </Row>
          )}
