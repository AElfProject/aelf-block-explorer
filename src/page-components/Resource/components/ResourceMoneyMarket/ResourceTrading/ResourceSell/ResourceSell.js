...
class ResourceSell extends Component {
  ...
  getElfValue(value) {
    ...
    getEstimatedValueRes(currentResourceType, value, tokenConverterContract, tokenContract)
      .then((result) => {
  ...
  getSellModalShow() {
    ...
    const { currentWallet, contracts, toSell, appName, nightElf, operateNumToSmall } = this.state;
