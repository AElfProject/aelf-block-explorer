...
class RedeemModal extends PureComponent {
  ...
  generateVoteRedeemForm() {
    ...
    return {
      formItems: [
        {
          label: 'Node Name',
          render: <span className="form-item-value text-ellipsis">{nodeName}</span>,
        },
        {
          label: 'Node Add',
          render: <span className="form-item-value text-ellipsis">{nodeAddress}</span>,
        },
        {
          label: 'Active Vote',
          render: (
        ...
        {
          label: 'Redeem To',
          render: <span className="form-item-value">{currentWallet && currentWallet.name}</span>,
        },
      ],
    };
  }
  ...
  render() {
    const { voteRedeemModalVisible, handleCancel, redeemConfirmLoading } = this.props;
