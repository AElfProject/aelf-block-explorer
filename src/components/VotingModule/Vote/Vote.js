...
import {tokenContract, transactionInfo} from '../../../utils';
...
export default class Vote extends PureComponent {
    ...
    getNextStep() {
        ...
        if (this.state.step) {
            ...
            this.consensus.Vote(this.state.publicKey, this.state.votes, this.state.period);
            message.success('No withdrawal and transfer operations during the voting lock period!');
            //    TODO
        }
    }
